...
score jumps. Measured on `combine/train.jsonl[:300]`, L0:
...
def main() -> None:
    ...
    ap.add_argument("--dataset", default="data/combine/train.jsonl", help="fitting set")
    ...
    assert not any(dataset.name == f for f in forbidden), (
        ...
        f"SUMMARY.md. Use data/combine/train.jsonl, or a split you created for fitting.")
