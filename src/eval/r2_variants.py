"""Experiment runner: score R2 variants side by side, clean and stressed, and register the results.
    ...
    python3 -m src.eval.r2_variants quick     # floors + full R2, offline dense, no registry write
    python3 -m src.eval.r2_variants full      # every variant + stress + ablations, writes runs/registry.jsonl
...
from src.r2.catalog import CatalogIndex  # noqa: E402
