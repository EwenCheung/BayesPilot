...
- **BLaIR / bge-m3 / any dense route.** R3 ships with no semantic term at all — see
  [SUMMARY.md](../SUMMARY.md) §7. Every number here is from lexical, attribute and exact evidence over a
  popularity prior.
