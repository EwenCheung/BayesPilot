...
[docs/R1-RESULTS.md](../R1-RESULTS.md).
...
- **Six defects the process caught** are logged with their symptoms in
  [docs/specs/r1-implementation-plan.md](../specs/r1-implementation-plan.md). Three of them (hash-order
...
1. **Spec first** — amend [docs/specs/r1-constraint-satisfaction.md](../specs/r1-constraint-satisfaction.md).
...
| [docs/specs/](../specs/) | This road's spec and its implementation/verification log |
| [docs/R1-RESULTS.md](../R1-RESULTS.md) | Every measurement, regenerated from the registry |
